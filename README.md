...
Thus, a Convolutional Autoencoder was successfully developed to remove noise from images. The model was trained using the MNIST dataset with added Gaussian noise and was able to reconstruct cleaner versions of the noisy images, demonstrating its effectiveness in image denoising.
